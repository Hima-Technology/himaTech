    ...
    <div className="bg-black text-white min-h-screen pt-32 pb-24">
      <Container className="max-w-3xl">
        ...
        <div className="mt-10 space-y-8 text-sm leading-relaxed text-neutral-400">
          ...
          <section>
            <h2 className="font-display text-xl font-bold text-white">Website Use</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="font-display text-xl font-bold text-white">Intellectual Property</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="font-display text-xl font-bold text-white">Client Engagements</h2>
            <p className="mt-3">
